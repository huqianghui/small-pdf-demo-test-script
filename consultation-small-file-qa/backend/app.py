...
AZURE_SEARCH_INDEX = os.environ.get("AZURE_SEARCH_INDEX") or "consultation4"
...
# blob storage config
AZURE_BLOB_STORAGE_ACCOUNT = os.environ.get("AZURE_BLOB_STORAGE_ACCOUNT") or "pdftestsa"
AZURE_BLOB_STORAGE_CONTAINER = os.environ.get("AZURE_BLOB_STORAGE_CONTAINER") or "content"
AZURE_BLOB_STORAGE_ACCOUNT_ENDPOINT = os.environ.get("AZURE_BLOB_STORAGE_ACCOUNT_ENDPOINT") or "https://pdftestsa.blob.core.windows.net/"
...
chat_approaches = {
    "rrr": ChatReadRetrieveReadApproach(search_client, AZURE_OPENAI_CHATGPT_DEPLOYMENT, AZURE_OPENAI_GPT_DEPLOYMENT, KB_FIELDS_SOURCE_PATH, KB_FIELDS_CONTENT, KB_FIELDS_SOURCE_PATH,AZURE_BING_SEARCH_SUBSCRIPTION_KEY,AZURE_BING_SEARCH_ENDPOINT)
}
